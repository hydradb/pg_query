...
defmodule PgQuery.Node do
  ...
  oneof(:node, 0)
  field(:alias, 1, type: PgQuery.Alias, oneof: 0)
  field(:range_var, 2, type: PgQuery.RangeVar, oneof: 0)
  field(:table_func, 3, type: PgQuery.TableFunc, oneof: 0)
  field(:expr, 4, type: PgQuery.Expr, oneof: 0)
  field(:var, 5, type: PgQuery.Var, oneof: 0)
  field(:param, 6, type: PgQuery.Param, oneof: 0)
  field(:aggref, 7, type: PgQuery.Aggref, oneof: 0)
  field(:grouping_func, 8, type: PgQuery.GroupingFunc, oneof: 0)
  field(:window_func, 9, type: PgQuery.WindowFunc, oneof: 0)
  field(:subscripting_ref, 10, type: PgQuery.SubscriptingRef, oneof: 0)
  field(:func_expr, 11, type: PgQuery.FuncExpr, oneof: 0)
  field(:named_arg_expr, 12, type: PgQuery.NamedArgExpr, oneof: 0)
  field(:op_expr, 13, type: PgQuery.OpExpr, oneof: 0)
  field(:distinct_expr, 14, type: PgQuery.DistinctExpr, oneof: 0)
  field(:null_if_expr, 15, type: PgQuery.NullIfExpr, oneof: 0)
  field(:scalar_array_op_expr, 16, type: PgQuery.ScalarArrayOpExpr, oneof: 0)
  field(:bool_expr, 17, type: PgQuery.BoolExpr, oneof: 0)
  field(:sub_link, 18, type: PgQuery.SubLink, oneof: 0)
  field(:sub_plan, 19, type: PgQuery.SubPlan, oneof: 0)
  field(:alternative_sub_plan, 20, type: PgQuery.AlternativeSubPlan, oneof: 0)
  field(:field_select, 21, type: PgQuery.FieldSelect, oneof: 0)
  field(:field_store, 22, type: PgQuery.FieldStore, oneof: 0)
  field(:relabel_type, 23, type: PgQuery.RelabelType, oneof: 0)
  field(:coerce_via_io, 24, type: PgQuery.CoerceViaIO, oneof: 0)
  field(:array_coerce_expr, 25, type: PgQuery.ArrayCoerceExpr, oneof: 0)
  field(:convert_rowtype_expr, 26, type: PgQuery.ConvertRowtypeExpr, oneof: 0)
  field(:collate_expr, 27, type: PgQuery.CollateExpr, oneof: 0)
  field(:case_expr, 28, type: PgQuery.CaseExpr, oneof: 0)
  field(:case_when, 29, type: PgQuery.CaseWhen, oneof: 0)
  field(:case_test_expr, 30, type: PgQuery.CaseTestExpr, oneof: 0)
  field(:array_expr, 31, type: PgQuery.ArrayExpr, oneof: 0)
  field(:row_expr, 32, type: PgQuery.RowExpr, oneof: 0)
  field(:row_compare_expr, 33, type: PgQuery.RowCompareExpr, oneof: 0)
  field(:coalesce_expr, 34, type: PgQuery.CoalesceExpr, oneof: 0)
  field(:min_max_expr, 35, type: PgQuery.MinMaxExpr, oneof: 0)
  field(:sqlvalue_function, 36, type: PgQuery.SQLValueFunction, oneof: 0)
  field(:xml_expr, 37, type: PgQuery.XmlExpr, oneof: 0)
  field(:null_test, 38, type: PgQuery.NullTest, oneof: 0)
  field(:boolean_test, 39, type: PgQuery.BooleanTest, oneof: 0)
  field(:coerce_to_domain, 40, type: PgQuery.CoerceToDomain, oneof: 0)
  field(:coerce_to_domain_value, 41, type: PgQuery.CoerceToDomainValue, oneof: 0)
  field(:set_to_default, 42, type: PgQuery.SetToDefault, oneof: 0)
  field(:current_of_expr, 43, type: PgQuery.CurrentOfExpr, oneof: 0)
  field(:next_value_expr, 44, type: PgQuery.NextValueExpr, oneof: 0)
  field(:inference_elem, 45, type: PgQuery.InferenceElem, oneof: 0)
  field(:target_entry, 46, type: PgQuery.TargetEntry, oneof: 0)
  field(:range_tbl_ref, 47, type: PgQuery.RangeTblRef, oneof: 0)
  field(:join_expr, 48, type: PgQuery.JoinExpr, oneof: 0)
  field(:from_expr, 49, type: PgQuery.FromExpr, oneof: 0)
  field(:on_conflict_expr, 50, type: PgQuery.OnConflictExpr, oneof: 0)
  field(:into_clause, 51, type: PgQuery.IntoClause, oneof: 0)
  field(:raw_stmt, 52, type: PgQuery.RawStmt, oneof: 0)
  field(:query, 53, type: PgQuery.Query, oneof: 0)
  field(:insert_stmt, 54, type: PgQuery.InsertStmt, oneof: 0)
  field(:delete_stmt, 55, type: PgQuery.DeleteStmt, oneof: 0)
  field(:update_stmt, 56, type: PgQuery.UpdateStmt, oneof: 0)
  field(:select_stmt, 57, type: PgQuery.SelectStmt, oneof: 0)
  field(:alter_table_stmt, 58, type: PgQuery.AlterTableStmt, oneof: 0)
  field(:alter_table_cmd, 59, type: PgQuery.AlterTableCmd, oneof: 0)
  field(:alter_domain_stmt, 60, type: PgQuery.AlterDomainStmt, oneof: 0)
  field(:set_operation_stmt, 61, type: PgQuery.SetOperationStmt, oneof: 0)
  field(:grant_stmt, 62, type: PgQuery.GrantStmt, oneof: 0)
  field(:grant_role_stmt, 63, type: PgQuery.GrantRoleStmt, oneof: 0)
  field(:alter_default_privileges_stmt, 64, type: PgQuery.AlterDefaultPrivilegesStmt, oneof: 0)
  field(:close_portal_stmt, 65, type: PgQuery.ClosePortalStmt, oneof: 0)
  field(:cluster_stmt, 66, type: PgQuery.ClusterStmt, oneof: 0)
  field(:copy_stmt, 67, type: PgQuery.CopyStmt, oneof: 0)
  field(:create_stmt, 68, type: PgQuery.CreateStmt, oneof: 0)
  field(:define_stmt, 69, type: PgQuery.DefineStmt, oneof: 0)
  field(:drop_stmt, 70, type: PgQuery.DropStmt, oneof: 0)
  field(:truncate_stmt, 71, type: PgQuery.TruncateStmt, oneof: 0)
  field(:comment_stmt, 72, type: PgQuery.CommentStmt, oneof: 0)
  field(:fetch_stmt, 73, type: PgQuery.FetchStmt, oneof: 0)
  field(:index_stmt, 74, type: PgQuery.IndexStmt, oneof: 0)
  field(:create_function_stmt, 75, type: PgQuery.CreateFunctionStmt, oneof: 0)
  field(:alter_function_stmt, 76, type: PgQuery.AlterFunctionStmt, oneof: 0)
  field(:do_stmt, 77, type: PgQuery.DoStmt, oneof: 0)
  field(:rename_stmt, 78, type: PgQuery.RenameStmt, oneof: 0)
  field(:rule_stmt, 79, type: PgQuery.RuleStmt, oneof: 0)
  field(:notify_stmt, 80, type: PgQuery.NotifyStmt, oneof: 0)
  field(:listen_stmt, 81, type: PgQuery.ListenStmt, oneof: 0)
  field(:unlisten_stmt, 82, type: PgQuery.UnlistenStmt, oneof: 0)
  field(:transaction_stmt, 83, type: PgQuery.TransactionStmt, oneof: 0)
  field(:view_stmt, 84, type: PgQuery.ViewStmt, oneof: 0)
  field(:load_stmt, 85, type: PgQuery.LoadStmt, oneof: 0)
  field(:create_domain_stmt, 86, type: PgQuery.CreateDomainStmt, oneof: 0)
  field(:createdb_stmt, 87, type: PgQuery.CreatedbStmt, oneof: 0)
  field(:dropdb_stmt, 88, type: PgQuery.DropdbStmt, oneof: 0)
  field(:vacuum_stmt, 89, type: PgQuery.VacuumStmt, oneof: 0)
  field(:explain_stmt, 90, type: PgQuery.ExplainStmt, oneof: 0)
  field(:create_table_as_stmt, 91, type: PgQuery.CreateTableAsStmt, oneof: 0)
  field(:create_seq_stmt, 92, type: PgQuery.CreateSeqStmt, oneof: 0)
  field(:alter_seq_stmt, 93, type: PgQuery.AlterSeqStmt, oneof: 0)
  field(:variable_set_stmt, 94, type: PgQuery.VariableSetStmt, oneof: 0)
  field(:variable_show_stmt, 95, type: PgQuery.VariableShowStmt, oneof: 0)
  field(:discard_stmt, 96, type: PgQuery.DiscardStmt, oneof: 0)
  field(:create_trig_stmt, 97, type: PgQuery.CreateTrigStmt, oneof: 0)
  field(:create_plang_stmt, 98, type: PgQuery.CreatePLangStmt, oneof: 0)
  field(:create_role_stmt, 99, type: PgQuery.CreateRoleStmt, oneof: 0)
  field(:alter_role_stmt, 100, type: PgQuery.AlterRoleStmt, oneof: 0)
  field(:drop_role_stmt, 101, type: PgQuery.DropRoleStmt, oneof: 0)
  field(:lock_stmt, 102, type: PgQuery.LockStmt, oneof: 0)
  field(:constraints_set_stmt, 103, type: PgQuery.ConstraintsSetStmt, oneof: 0)
  field(:reindex_stmt, 104, type: PgQuery.ReindexStmt, oneof: 0)
  field(:check_point_stmt, 105, type: PgQuery.CheckPointStmt, oneof: 0)
  field(:create_schema_stmt, 106, type: PgQuery.CreateSchemaStmt, oneof: 0)
  field(:alter_database_stmt, 107, type: PgQuery.AlterDatabaseStmt, oneof: 0)
  field(:alter_database_set_stmt, 108, type: PgQuery.AlterDatabaseSetStmt, oneof: 0)
  field(:alter_role_set_stmt, 109, type: PgQuery.AlterRoleSetStmt, oneof: 0)
  field(:create_conversion_stmt, 110, type: PgQuery.CreateConversionStmt, oneof: 0)
  field(:create_cast_stmt, 111, type: PgQuery.CreateCastStmt, oneof: 0)
  field(:create_op_class_stmt, 112, type: PgQuery.CreateOpClassStmt, oneof: 0)
  field(:create_op_family_stmt, 113, type: PgQuery.CreateOpFamilyStmt, oneof: 0)
  field(:alter_op_family_stmt, 114, type: PgQuery.AlterOpFamilyStmt, oneof: 0)
  field(:prepare_stmt, 115, type: PgQuery.PrepareStmt, oneof: 0)
  field(:execute_stmt, 116, type: PgQuery.ExecuteStmt, oneof: 0)
  field(:deallocate_stmt, 117, type: PgQuery.DeallocateStmt, oneof: 0)
  field(:declare_cursor_stmt, 118, type: PgQuery.DeclareCursorStmt, oneof: 0)
  field(:create_table_space_stmt, 119, type: PgQuery.CreateTableSpaceStmt, oneof: 0)
  field(:drop_table_space_stmt, 120, type: PgQuery.DropTableSpaceStmt, oneof: 0)
  field(:alter_object_depends_stmt, 121, type: PgQuery.AlterObjectDependsStmt, oneof: 0)
  field(:alter_object_schema_stmt, 122, type: PgQuery.AlterObjectSchemaStmt, oneof: 0)
  field(:alter_owner_stmt, 123, type: PgQuery.AlterOwnerStmt, oneof: 0)
  field(:alter_operator_stmt, 124, type: PgQuery.AlterOperatorStmt, oneof: 0)
  field(:alter_type_stmt, 125, type: PgQuery.AlterTypeStmt, oneof: 0)
  field(:drop_owned_stmt, 126, type: PgQuery.DropOwnedStmt, oneof: 0)
  field(:reassign_owned_stmt, 127, type: PgQuery.ReassignOwnedStmt, oneof: 0)
  field(:composite_type_stmt, 128, type: PgQuery.CompositeTypeStmt, oneof: 0)
  field(:create_enum_stmt, 129, type: PgQuery.CreateEnumStmt, oneof: 0)
  field(:create_range_stmt, 130, type: PgQuery.CreateRangeStmt, oneof: 0)
  field(:alter_enum_stmt, 131, type: PgQuery.AlterEnumStmt, oneof: 0)
  field(:alter_tsdictionary_stmt, 132, type: PgQuery.AlterTSDictionaryStmt, oneof: 0)
  field(:alter_tsconfiguration_stmt, 133, type: PgQuery.AlterTSConfigurationStmt, oneof: 0)
  field(:create_fdw_stmt, 134, type: PgQuery.CreateFdwStmt, oneof: 0)
  field(:alter_fdw_stmt, 135, type: PgQuery.AlterFdwStmt, oneof: 0)
  field(:create_foreign_server_stmt, 136, type: PgQuery.CreateForeignServerStmt, oneof: 0)
  field(:alter_foreign_server_stmt, 137, type: PgQuery.AlterForeignServerStmt, oneof: 0)
  field(:create_user_mapping_stmt, 138, type: PgQuery.CreateUserMappingStmt, oneof: 0)
  field(:alter_user_mapping_stmt, 139, type: PgQuery.AlterUserMappingStmt, oneof: 0)
  field(:drop_user_mapping_stmt, 140, type: PgQuery.DropUserMappingStmt, oneof: 0)
  field(:alter_table_space_options_stmt, 141, type: PgQuery.AlterTableSpaceOptionsStmt, oneof: 0)
  field(:alter_table_move_all_stmt, 142, type: PgQuery.AlterTableMoveAllStmt, oneof: 0)
  field(:sec_label_stmt, 143, type: PgQuery.SecLabelStmt, oneof: 0)
  field(:create_foreign_table_stmt, 144, type: PgQuery.CreateForeignTableStmt, oneof: 0)
  field(:import_foreign_schema_stmt, 145, type: PgQuery.ImportForeignSchemaStmt, oneof: 0)
  field(:create_extension_stmt, 146, type: PgQuery.CreateExtensionStmt, oneof: 0)
  field(:alter_extension_stmt, 147, type: PgQuery.AlterExtensionStmt, oneof: 0)
  field(:alter_extension_contents_stmt, 148, type: PgQuery.AlterExtensionContentsStmt, oneof: 0)
  field(:create_event_trig_stmt, 149, type: PgQuery.CreateEventTrigStmt, oneof: 0)
  field(:alter_event_trig_stmt, 150, type: PgQuery.AlterEventTrigStmt, oneof: 0)
  field(:refresh_mat_view_stmt, 151, type: PgQuery.RefreshMatViewStmt, oneof: 0)
  field(:replica_identity_stmt, 152, type: PgQuery.ReplicaIdentityStmt, oneof: 0)
  field(:alter_system_stmt, 153, type: PgQuery.AlterSystemStmt, oneof: 0)
  field(:create_policy_stmt, 154, type: PgQuery.CreatePolicyStmt, oneof: 0)
  field(:alter_policy_stmt, 155, type: PgQuery.AlterPolicyStmt, oneof: 0)
  field(:create_transform_stmt, 156, type: PgQuery.CreateTransformStmt, oneof: 0)
  field(:create_am_stmt, 157, type: PgQuery.CreateAmStmt, oneof: 0)
  field(:create_publication_stmt, 158, type: PgQuery.CreatePublicationStmt, oneof: 0)
  field(:alter_publication_stmt, 159, type: PgQuery.AlterPublicationStmt, oneof: 0)
  field(:create_subscription_stmt, 160, type: PgQuery.CreateSubscriptionStmt, oneof: 0)
  field(:alter_subscription_stmt, 161, type: PgQuery.AlterSubscriptionStmt, oneof: 0)
  field(:drop_subscription_stmt, 162, type: PgQuery.DropSubscriptionStmt, oneof: 0)
  field(:create_stats_stmt, 163, type: PgQuery.CreateStatsStmt, oneof: 0)
  field(:alter_collation_stmt, 164, type: PgQuery.AlterCollationStmt, oneof: 0)
  field(:call_stmt, 165, type: PgQuery.CallStmt, oneof: 0)
  field(:alter_stats_stmt, 166, type: PgQuery.AlterStatsStmt, oneof: 0)
  field(:a_expr, 167, type: PgQuery.A_Expr, oneof: 0)
  field(:column_ref, 168, type: PgQuery.ColumnRef, oneof: 0)
  field(:param_ref, 169, type: PgQuery.ParamRef, oneof: 0)
  field(:a_const, 170, type: PgQuery.A_Const, oneof: 0)
  field(:func_call, 171, type: PgQuery.FuncCall, oneof: 0)
  field(:a_star, 172, type: PgQuery.A_Star, oneof: 0)
  field(:a_indices, 173, type: PgQuery.A_Indices, oneof: 0)
  field(:a_indirection, 174, type: PgQuery.A_Indirection, oneof: 0)
  field(:a_array_expr, 175, type: PgQuery.A_ArrayExpr, oneof: 0)
  field(:res_target, 176, type: PgQuery.ResTarget, oneof: 0)
  field(:multi_assign_ref, 177, type: PgQuery.MultiAssignRef, oneof: 0)
  field(:type_cast, 178, type: PgQuery.TypeCast, oneof: 0)
  field(:collate_clause, 179, type: PgQuery.CollateClause, oneof: 0)
  field(:sort_by, 180, type: PgQuery.SortBy, oneof: 0)
  field(:window_def, 181, type: PgQuery.WindowDef, oneof: 0)
  field(:range_subselect, 182, type: PgQuery.RangeSubselect, oneof: 0)
  field(:range_function, 183, type: PgQuery.RangeFunction, oneof: 0)
  field(:range_table_sample, 184, type: PgQuery.RangeTableSample, oneof: 0)
  field(:range_table_func, 185, type: PgQuery.RangeTableFunc, oneof: 0)
  field(:range_table_func_col, 186, type: PgQuery.RangeTableFuncCol, oneof: 0)
  field(:type_name, 187, type: PgQuery.TypeName, oneof: 0)
  field(:column_def, 188, type: PgQuery.ColumnDef, oneof: 0)
  field(:index_elem, 189, type: PgQuery.IndexElem, oneof: 0)
  field(:constraint, 190, type: PgQuery.Constraint, oneof: 0)
  field(:def_elem, 191, type: PgQuery.DefElem, oneof: 0)
  field(:range_tbl_entry, 192, type: PgQuery.RangeTblEntry, oneof: 0)
  field(:range_tbl_function, 193, type: PgQuery.RangeTblFunction, oneof: 0)
  field(:table_sample_clause, 194, type: PgQuery.TableSampleClause, oneof: 0)
  field(:with_check_option, 195, type: PgQuery.WithCheckOption, oneof: 0)
  field(:sort_group_clause, 196, type: PgQuery.SortGroupClause, oneof: 0)
  field(:grouping_set, 197, type: PgQuery.GroupingSet, oneof: 0)
  field(:window_clause, 198, type: PgQuery.WindowClause, oneof: 0)
  field(:object_with_args, 199, type: PgQuery.ObjectWithArgs, oneof: 0)
  field(:access_priv, 200, type: PgQuery.AccessPriv, oneof: 0)
  field(:create_op_class_item, 201, type: PgQuery.CreateOpClassItem, oneof: 0)
  field(:table_like_clause, 202, type: PgQuery.TableLikeClause, oneof: 0)
  field(:function_parameter, 203, type: PgQuery.FunctionParameter, oneof: 0)
  field(:locking_clause, 204, type: PgQuery.LockingClause, oneof: 0)
  field(:row_mark_clause, 205, type: PgQuery.RowMarkClause, oneof: 0)
  field(:xml_serialize, 206, type: PgQuery.XmlSerialize, oneof: 0)
  field(:with_clause, 207, type: PgQuery.WithClause, oneof: 0)
  field(:infer_clause, 208, type: PgQuery.InferClause, oneof: 0)
  field(:on_conflict_clause, 209, type: PgQuery.OnConflictClause, oneof: 0)
  field(:common_table_expr, 210, type: PgQuery.CommonTableExpr, oneof: 0)
  field(:role_spec, 211, type: PgQuery.RoleSpec, oneof: 0)
  field(:trigger_transition, 212, type: PgQuery.TriggerTransition, oneof: 0)
  field(:partition_elem, 213, type: PgQuery.PartitionElem, oneof: 0)
  field(:partition_spec, 214, type: PgQuery.PartitionSpec, oneof: 0)
  field(:partition_bound_spec, 215, type: PgQuery.PartitionBoundSpec, oneof: 0)
  field(:partition_range_datum, 216, type: PgQuery.PartitionRangeDatum, oneof: 0)
  field(:partition_cmd, 217, type: PgQuery.PartitionCmd, oneof: 0)
  field(:vacuum_relation, 218, type: PgQuery.VacuumRelation, oneof: 0)
  field(:inline_code_block, 219, type: PgQuery.InlineCodeBlock, oneof: 0)
  field(:call_context, 220, type: PgQuery.CallContext, oneof: 0)
  field(:integer, 221, type: PgQuery.Integer, oneof: 0)
  field(:float, 222, type: PgQuery.Float, oneof: 0)
  field(:string, 223, type: PgQuery.String, oneof: 0)
  field(:bit_string, 224, type: PgQuery.BitString, oneof: 0)
  field(:null, 225, type: PgQuery.Null, oneof: 0)
  field(:list, 226, type: PgQuery.List, oneof: 0)
  field(:int_list, 227, type: PgQuery.IntList, oneof: 0)
  field(:oid_list, 228, type: PgQuery.OidList, oneof: 0)
end
...
defmodule PgQuery.SubLink do
  ...
  field(:xpr, 1, type: PgQuery.Node)
  field(:sub_link_type, 2, type: PgQuery.SubLinkType, enum: true)
  field(:sub_link_id, 3, type: :int32)
  field(:testexpr, 4, type: PgQuery.Node)
  field(:oper_name, 5, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.SubPlan do
  ...
  field(:param_ids, 4, repeated: true, type: PgQuery.Node)
  field(:plan_id, 5, type: :int32)
  field(:plan_name, 6, type: :string)
  field(:first_col_type, 7, type: :uint32)
  field(:first_col_typmod, 8, type: :int32)
  field(:first_col_collation, 9, type: :uint32)
  field(:use_hash_table, 10, type: :bool)
  field(:unknown_eq_false, 11, type: :bool)
  field(:parallel_safe, 12, type: :bool)
  field(:set_param, 13, repeated: true, type: PgQuery.Node)
  field(:par_param, 14, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.CaseTestExpr do
  ...
  field(:xpr, 1, type: PgQuery.Node)
  field(:type_id, 2, type: :uint32)
  field(:type_mod, 3, type: :int32)
...
defmodule PgQuery.JoinExpr do
  ...
  field(:is_natural, 2, type: :bool)
  field(:larg, 3, type: PgQuery.Node)
  field(:rarg, 4, type: PgQuery.Node)
  field(:using_clause, 5, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.OnConflictExpr do
  ...
  field(:arbiter_elems, 2, repeated: true, type: PgQuery.Node)
  field(:arbiter_where, 3, type: PgQuery.Node)
  field(:constraint, 4, type: :uint32)
  field(:on_conflict_set, 5, repeated: true, type: PgQuery.Node)
  field(:on_conflict_where, 6, type: PgQuery.Node)
  field(:excl_rel_index, 7, type: :int32)
  field(:excl_rel_tlist, 8, repeated: true, type: PgQuery.Node)
end
...
defmodule PgQuery.IntoClause do
  ...
  field(:col_names, 2, repeated: true, type: PgQuery.Node)
  field(:access_method, 3, type: :string)
  field(:options, 4, repeated: true, type: PgQuery.Node)
  field(:on_commit, 5, type: PgQuery.OnCommitAction, enum: true)
  field(:table_space_name, 6, type: :string)
  field(:view_query, 7, type: PgQuery.Node)
  field(:skip_data, 8, type: :bool)
end
...
defmodule PgQuery.Query do
  ...
  field(:command_type, 1, type: PgQuery.CmdType, enum: true)
  field(:query_source, 2, type: PgQuery.QuerySource, enum: true)
  field(:can_set_tag, 3, type: :bool)
  field(:utility_stmt, 4, type: PgQuery.Node)
  field(:result_relation, 5, type: :int32)
  field(:has_aggs, 6, type: :bool)
  field(:has_window_funcs, 7, type: :bool)
  field(:has_target_srfs, 8, type: :bool)
  field(:has_sub_links, 9, type: :bool)
  field(:has_distinct_on, 10, type: :bool)
  field(:has_recursive, 11, type: :bool)
  field(:has_modifying_cte, 12, type: :bool)
  field(:has_for_update, 13, type: :bool)
  field(:has_row_security, 14, type: :bool)
  field(:cte_list, 15, repeated: true, type: PgQuery.Node)
  field(:rtable, 16, repeated: true, type: PgQuery.Node)
  field(:jointree, 17, type: PgQuery.FromExpr)
  field(:target_list, 18, repeated: true, type: PgQuery.Node)
  field(:override, 19, type: PgQuery.OverridingKind, enum: true)
  field(:on_conflict, 20, type: PgQuery.OnConflictExpr)
  field(:returning_list, 21, repeated: true, type: PgQuery.Node)
  field(:group_clause, 22, repeated: true, type: PgQuery.Node)
  field(:grouping_sets, 23, repeated: true, type: PgQuery.Node)
  field(:having_qual, 24, type: PgQuery.Node)
  field(:window_clause, 25, repeated: true, type: PgQuery.Node)
  field(:distinct_clause, 26, repeated: true, type: PgQuery.Node)
  field(:sort_clause, 27, repeated: true, type: PgQuery.Node)
  field(:limit_offset, 28, type: PgQuery.Node)
  field(:limit_count, 29, type: PgQuery.Node)
  field(:limit_option, 30, type: PgQuery.LimitOption, enum: true)
  field(:row_marks, 31, repeated: true, type: PgQuery.Node)
  field(:set_operations, 32, type: PgQuery.Node)
  field(:constraint_deps, 33, repeated: true, type: PgQuery.Node)
  field(:with_check_options, 34, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.InsertStmt do
  ...
  field(:select_stmt, 3, type: PgQuery.Node)
  field(:on_conflict_clause, 4, type: PgQuery.OnConflictClause)
  field(:returning_list, 5, repeated: true, type: PgQuery.Node)
  field(:with_clause, 6, type: PgQuery.WithClause)
...
defmodule PgQuery.DeleteStmt do
  ...
  field(:relation, 1, type: PgQuery.RangeVar)
  field(:using_clause, 2, repeated: true, type: PgQuery.Node)
  field(:where_clause, 3, type: PgQuery.Node)
  field(:returning_list, 4, repeated: true, type: PgQuery.Node)
  field(:with_clause, 5, type: PgQuery.WithClause)
end
...
defmodule PgQuery.UpdateStmt do
  ...
  field(:relation, 1, type: PgQuery.RangeVar)
  field(:target_list, 2, repeated: true, type: PgQuery.Node)
  field(:where_clause, 3, type: PgQuery.Node)
  field(:from_clause, 4, repeated: true, type: PgQuery.Node)
  field(:returning_list, 5, repeated: true, type: PgQuery.Node)
  field(:with_clause, 6, type: PgQuery.WithClause)
end
...
defmodule PgQuery.SelectStmt do
  ...
  field(:distinct_clause, 1, repeated: true, type: PgQuery.Node)
  field(:into_clause, 2, type: PgQuery.IntoClause)
  field(:target_list, 3, repeated: true, type: PgQuery.Node)
  field(:from_clause, 4, repeated: true, type: PgQuery.Node)
  field(:where_clause, 5, type: PgQuery.Node)
  field(:group_clause, 6, repeated: true, type: PgQuery.Node)
  field(:having_clause, 7, type: PgQuery.Node)
  field(:window_clause, 8, repeated: true, type: PgQuery.Node)
  field(:values_lists, 9, repeated: true, type: PgQuery.Node)
  field(:sort_clause, 10, repeated: true, type: PgQuery.Node)
  field(:limit_offset, 11, type: PgQuery.Node)
  field(:limit_count, 12, type: PgQuery.Node)
  field(:limit_option, 13, type: PgQuery.LimitOption, enum: true)
  field(:locking_clause, 14, repeated: true, type: PgQuery.Node)
  field(:with_clause, 15, type: PgQuery.WithClause)
...
defmodule PgQuery.AlterDomainStmt do
  ...
  field(:type_name, 2, repeated: true, type: PgQuery.Node)
  field(:name, 3, type: :string)
...
defmodule PgQuery.SetOperationStmt do
  ...
  field(:larg, 3, type: PgQuery.Node)
  field(:rarg, 4, type: PgQuery.Node)
  field(:col_types, 5, repeated: true, type: PgQuery.Node)
  field(:col_typmods, 6, repeated: true, type: PgQuery.Node)
  field(:col_collations, 7, repeated: true, type: PgQuery.Node)
  field(:group_clauses, 8, repeated: true, type: PgQuery.Node)
end
...
defmodule PgQuery.CopyStmt do
  ...
  field(:where_clause, 8, type: PgQuery.Node)
end
...
defmodule PgQuery.CreateStmt do
  ...
  field(:relation, 1, type: PgQuery.RangeVar)
  field(:table_elts, 2, repeated: true, type: PgQuery.Node)
  field(:inh_relations, 3, repeated: true, type: PgQuery.Node)
  field(:partbound, 4, type: PgQuery.PartitionBoundSpec)
  field(:partspec, 5, type: PgQuery.PartitionSpec)
  field(:of_typename, 6, type: PgQuery.TypeName)
  ...
  field(:access_method, 11, type: :string)
...
defmodule PgQuery.DropStmt do
  ...
  field(:remove_type, 2, type: PgQuery.ObjectType, enum: true)
...
defmodule PgQuery.IndexStmt do
  ...
  field(:access_method, 3, type: :string)
  field(:table_space, 4, type: :string)
  field(:index_params, 5, repeated: true, type: PgQuery.Node)
  field(:index_including_params, 6, repeated: true, type: PgQuery.Node)
  field(:options, 7, repeated: true, type: PgQuery.Node)
  field(:where_clause, 8, type: PgQuery.Node)
  field(:exclude_op_names, 9, repeated: true, type: PgQuery.Node)
  field(:idxcomment, 10, type: :string)
  field(:index_oid, 11, type: :uint32)
  field(:old_node, 12, type: :uint32)
  field(:old_create_subid, 13, type: :uint32)
  field(:old_first_relfilenode_subid, 14, type: :uint32)
...
defmodule PgQuery.CreateFunctionStmt do
  ...
  field(:return_type, 5, type: PgQuery.TypeName)
...
defmodule PgQuery.RenameStmt do
  ...
  field(:rename_type, 1, type: PgQuery.ObjectType, enum: true)
  field(:relation_type, 2, type: PgQuery.ObjectType, enum: true)
...
defmodule PgQuery.ViewStmt do
  ...
  field(:with_check_option, 6, type: PgQuery.ViewCheckOption, enum: true)
end
...
defmodule PgQuery.CreateDomainStmt do
  ...
  field(:coll_clause, 3, type: PgQuery.CollateClause)
...
defmodule PgQuery.CreateTrigStmt do
  ...
  field(:when_clause, 9, type: PgQuery.Node)
  field(:isconstraint, 10, type: :bool)
  field(:transition_rels, 11, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.CreateSchemaStmt do
  ...
  field(:schema_elts, 3, repeated: true, type: PgQuery.Node)
...
defmodule PgQuery.AlterObjectDependsStmt do
  ...
  field(:object_type, 1, type: PgQuery.ObjectType, enum: true)
  field(:relation, 2, type: PgQuery.RangeVar)
...
defmodule PgQuery.AlterTypeStmt do
  ...
  field(:type_name, 1, repeated: true, type: PgQuery.Node)
  field(:options, 2, repeated: true, type: PgQuery.Node)
end
...
defmodule PgQuery.AlterEnumStmt do
  ...
  field(:type_name, 1, repeated: true, type: PgQuery.Node)
  field(:old_val, 2, type: :string)
  field(:new_val, 3, type: :string)
  field(:new_val_neighbor, 4, type: :string)
  field(:new_val_is_after, 5, type: :bool)
  field(:skip_if_new_val_exists, 6, type: :bool)
end
...
defmodule PgQuery.CreateForeignTableStmt do
  ...
  field(:base_stmt, 1, type: PgQuery.CreateStmt)
  field(:servername, 2, type: :string)
  field(:options, 3, repeated: true, type: PgQuery.Node)
end
...
defmodule PgQuery.AlterPublicationStmt do
  ...
  field(:tables, 3, repeated: true, type: PgQuery.Node)
  field(:for_all_tables, 4, type: :bool)
  field(:table_action, 5, type: PgQuery.DefElemAction, enum: true)
end
...
defmodule PgQuery.SortBy do
  ...
  field(:use_op, 4, repeated: true, type: PgQuery.Node)
  field(:location, 5, type: :int32)
end
...
defmodule PgQuery.WindowDef do
  ...
  field(:partition_clause, 3, repeated: true, type: PgQuery.Node)
  field(:order_clause, 4, repeated: true, type: PgQuery.Node)
  field(:frame_options, 5, type: :int32)
  field(:start_offset, 6, type: PgQuery.Node)
  field(:end_offset, 7, type: PgQuery.Node)
  field(:location, 8, type: :int32)
end
...
defmodule PgQuery.TypeName do
  ...
  field(:array_bounds, 7, repeated: true, type: PgQuery.Node)
  field(:location, 8, type: :int32)
end
...
defmodule PgQuery.ColumnDef do
  ...
  field(:identity_sequence, 11, type: PgQuery.RangeVar)
  field(:generated, 12, type: :string)
  field(:coll_clause, 13, type: PgQuery.CollateClause)
  field(:coll_oid, 14, type: :uint32)
...
defmodule PgQuery.RangeTblEntry do
  ...
  field(:in_from_cl, 29, type: :bool)
  field(:required_perms, 30, type: :uint32)
  field(:check_as_user, 31, type: :uint32)
  field(:selected_cols, 32, repeated: true, type: :uint64)
  field(:inserted_cols, 33, repeated: true, type: :uint64)
  field(:updated_cols, 34, repeated: true, type: :uint64)
  field(:extra_updated_cols, 35, repeated: true, type: :uint64)
  field(:security_quals, 36, repeated: true, type: PgQuery.Node)
end
...
defmodule PgQuery.SortGroupClause do
  ...
  field(:tle_sort_group_ref, 1, type: :uint32)
...
defmodule PgQuery.WindowClause do
  ...
  field(:start_offset, 6, type: PgQuery.Node)
  field(:end_offset, 7, type: PgQuery.Node)
  field(:start_in_range_func, 8, type: :uint32)
  field(:end_in_range_func, 9, type: :uint32)
  field(:in_range_coll, 10, type: :uint32)
  field(:in_range_asc, 11, type: :bool)
  field(:in_range_nulls_first, 12, type: :bool)
  field(:winref, 13, type: :uint32)
  field(:copied_order, 14, type: :bool)
end
...
defmodule PgQuery.TableLikeClause do
  ...
  field(:relation_oid, 3, type: :uint32)
end
...
defmodule PgQuery.FunctionParameter do
  ...
  field(:name, 1, type: :string)
  field(:arg_type, 2, type: PgQuery.TypeName)
...
defmodule PgQuery.LockingClause do
  ...
  field(:locked_rels, 1, repeated: true, type: PgQuery.Node)
  field(:strength, 2, type: PgQuery.LockClauseStrength, enum: true)
  field(:wait_policy, 3, type: PgQuery.LockWaitPolicy, enum: true)
end
...
defmodule PgQuery.XmlSerialize do
  ...
  field(:expr, 2, type: PgQuery.Node)
  field(:type_name, 3, type: PgQuery.TypeName)
  field(:location, 4, type: :int32)
end
...
defmodule PgQuery.InferClause do
  ...
  field(:index_elems, 1, repeated: true, type: PgQuery.Node)
  field(:where_clause, 2, type: PgQuery.Node)
...
defmodule PgQuery.OnConflictClause do
  ...
  field(:target_list, 3, repeated: true, type: PgQuery.Node)
  field(:where_clause, 4, type: PgQuery.Node)
  field(:location, 5, type: :int32)
end
...
defmodule PgQuery.TriggerTransition do
  ...
  field(:name, 1, type: :string)
  field(:is_new, 2, type: :bool)
  field(:is_table, 3, type: :bool)
end
...
defmodule PgQuery.PartitionSpec do
  ...
  field(:part_params, 2, repeated: true, type: PgQuery.Node)
  field(:location, 3, type: :int32)
end
...
defmodule PgQuery.InlineCodeBlock do
  ...
  field(:lang_oid, 2, type: :uint32)
  field(:lang_is_trusted, 3, type: :bool)
...
defmodule PgQuery.ScanToken do
  ...
  field(:keyword_kind, 5, type: PgQuery.KeywordKind, enum: true)
end
